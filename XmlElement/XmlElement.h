...
namespace XmlProcessing
{
  ...
  public:
	...
	virtual std::vector<std::pair<std::string, std::string>> attr() = 0;
  ...
  public:
	DocElement(){}
    DocElement(std::shared_ptr<AbstractXmlElement> pRoot);
    ~DocElement() {}
  ...
  std::shared_ptr<AbstractXmlElement> makeEmptyDocElement();
  ...
  public:
	...
	virtual std::vector<std::shared_ptr<AbstractXmlElement>> children(){ 
		std::vector<std::shared_ptr<AbstractXmlElement>> empty;
		return empty; }
	virtual std::vector<std::pair<std::string, std::string>> attr(){
		std::vector<std::pair<std::string, std::string>> empty;
		return empty;
  ...
  public:
    ...
    virtual bool addAttrib(const std::string& name, const std::string& value);
    virtual bool removeAttrib(const std::string& name);
	virtual std::string tag() { return tag_; }
	virtual std::vector<std::shared_ptr<AbstractXmlElement>> children(){
		return children_;
	}
	virtual std::vector<std::pair<std::string, std::string>> attr(){
